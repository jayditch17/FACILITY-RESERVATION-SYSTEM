...
=======
                <span class="avatar avatar-online">
                  ...
                  <i></i>
>>>>>>> 7205e760b21bf2cce3b6c92b1a008ae36a91e7cf
                </span>
              </a>
                            ...
                            <div class="row">
                              <div class="col-sm-12 col-md-4 col-xl-2">
                                <div class="example">
                                  <ul class="list-unstyled">
                                    <li class="mb-20">
                                      <button type="button" class="btn btn-block btn-default">DEVESSE PLAZA</button>
                                    </li>
                                  </ul>
                                </div>
                              </div>
                              ...
                              <div class="col-sm-12 col-md-4 col-xl-2">
                                <div class="example">
                                  <ul class="list-unstyled">
                                    <li class="mb-20">
                                      <button type="button" class="btn btn-block btn-primary">AMPHITHEATER</button>
                                    </li>
                                  </ul>
                                </div>
                              </div>
                              ...
                              <div class="col-sm-12 col-md-4 col-xl-2">
                                <div class="example">
                                  <ul class="list-unstyled">
                                    <li class="mb-20">
                                      <button type="button" class="btn btn-block btn-success">AVR</button>
                                    </li>
                                  </ul>
                                </div>
                              </div>
                              ...
                              <div class="col-sm-12 col-md-4 col-xl-2">
                                <div class="example">
                                  <ul class="list-unstyled">
                                    <li class="mb-20">
                                      <button type="button" class="btn btn-block btn-info">SWIMMING POOL</button>
                                    </li>
                                  </ul>
                                </div>
                              </div>
                              ...
                              <div class="col-sm-12 col-md-4 col-xl-2">
                                <div class="example">
                                  <ul class="list-unstyled">
                                    <li class="mb-20">
                                      <button type="button" class="btn btn-block btn-warning">OVAL</button>
                                    </li>
                                  </ul>
                                </div>
                              </div>
                              ...
                              <div class="col-sm-12 col-md-4 col-xl-2">
                                <div class="example">
                                  <ul class="list-unstyled">
                                    <li class="mb-20">
                                      <button type="button" class="btn btn-block btn-danger" data-toggle="dropdown" >COURTS</button>
                                      <div class="dropdown-menu" aria-labelledby="exampleIconDropdown1" role="menu">
                                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem">VOLLEYBALL COURT</a>
                                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem">BASKETBALL COURT</a>
                                      </div>
                                    </li>
                                  </ul>
                                </div>
